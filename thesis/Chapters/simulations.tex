...
Due to ambiguity this quantity cannot be interpreted if it is larger than half a period $\pi$.
The misfit function is defined as an $L_n$ norm. % What is n here????
% Weighting function
