...
and calibrated with the displacement function. % formula here?
...
The logarithm is used to emphasize waveforms with small amplitudes.
...
time-frequency domain and the weighting function $W_p$. Graphic from \citealp{Fichtner2008}.}
\label{weight_func}
\end{center}
\end{figure}
